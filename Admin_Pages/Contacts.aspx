<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Pages/Admin.Master" AutoEventWireup="true" CodeBehind="Contacts.aspx.cs" Inherits="MyAppGNI.Admin_Pages.Contacts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="text-center m-5">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Subject" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="false">
                <ItemTemplate>
                    <asp:Literal ID="ltlSubject" runat="server" Text='<%#Eval("Subject")%>' />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Left" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Messsage" HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="false">
                <ItemTemplate>
                    <asp:Literal ID="ltlMessage" runat="server" Text='<%#Eval("Message")%>' />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
    ...
    <script>
        document.getElementById("Contacts").className = "nav-link active";
    </script>
