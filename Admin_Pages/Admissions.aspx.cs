    ...
    public partial class Admissions : System.Web.UI.Page
    {
        ...
        public void ShowGridData()
        {
            try
            {
                ...
                SqlDataAdapter MyADP = new SqlDataAdapter("select * from TB_Admission order by Replied, RowID desc", MyCon);
        ...
        protected void btnReplied_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand MyCMD = new SqlCommand("update TB_Admission set Replied=~(Replied) where RowID=@rid", MyCon);
